      ...
      <div className="max-w-md mx-auto px-6 py-6 pb-32">
        ...
        <div className="flex bg-[#27272A] p-1 rounded-2xl mb-6">
          ...
          <button
            ...
            className={`flex-1 py-3 px-4 text-sm font-semibold rounded-xl transition-all ${
              activeTab === "fad" ? "bg-[#FF6B4A] text-white" : "text-zinc-400"
            }`}
          >
            FAD
          </button>
        ...
        {activeTab === "fad" && (
          <div className="space-y-6">
            ...
            <div className="bg-[#27272A] rounded-2xl p-6 border border-zinc-800">
              <div className="text-[#FF6B4A] text-xs font-semibold uppercase tracking-[2px] mb-3">
                Paper 2 · ERQ Question
              </div>
              <div className="text-white text-base font-semibold leading-snug mb-3">
                "Discuss one or more factors of diagnosis of one or more disorders."
              </div>
              <div className="text-zinc-400 text-[13px] leading-relaxed">
                ...
                <a
                  ...
                  className="text-[#FF6B4A] font-semibold underline underline-offset-2 hover:text-[#FF8B6A] transition-colors"
                >
            ...
            <div className="text-zinc-500 text-xs font-medium uppercase tracking-[1.5px]">
              Factors Affecting Diagnosis
            </div>

            {/* Common Mistake Tip */}
            <div className="bg-[#2C3E50] rounded-2xl p-4 flex gap-3 items-start border border-zinc-800">
              <div className="flex-shrink-0 w-7 h-7 flex items-center justify-center mt-0.5">
                <Lightbulb className="w-5 h-5 text-[#FF6B4A] stroke-[1.8]" />
              </div>
            ...
            <div className="bg-[#27272A] rounded-2xl p-6 mb-4 border border-zinc-800">
              <div className="flex items-center justify-between mb-5">
                <h3 className="text-white text-xl font-bold leading-tight">
                  Cultural Bias
                </h3>
                <div className="text-[#FF6B4A] text-[22px] font-bold">01</div>
              </div>

              <div className="mb-4">
                <div className="text-[#FF6B4A] text-[10px] font-semibold uppercase tracking-[2px] mb-2">
                  Why It's Important
                </div>
              ...
              <div className="bg-[#18181B] rounded-xl p-4 mt-4 border border-zinc-800">
                <div className="text-[#FF6B4A] text-[10px] font-semibold uppercase tracking-[2px] mb-2">
                  So What?
                </div>
                <div className="text-white text-[13.5px] leading-relaxed">
            ...
            <div className="bg-[#27272A] rounded-2xl p-6 border border-zinc-800">
              <div className="flex items-center justify-between mb-5">
                ...
                <div className="text-[#FF6B4A] text-[22px] font-bold">02</div>
              </div>

              {/* Nested Tip */}
              <div className="bg-[#2C3E50] rounded-2xl p-4 mb-5 flex gap-3 items-start border border-zinc-800">
                <div className="flex-shrink-0 w-7 h-7 flex items-center justify-center mt-0.5">
                  <Lightbulb className="w-5 h-5 text-[#FF6B4A] stroke-[1.8]" />
                </div>
                <div className="text-zinc-200 text-[13px] leading-relaxed">
        ...
        {activeTab === "tips" && (
          <div className="space-y-6">
            {TIPS.map((tip, i) => (
              <div
                key={i}
                className="bg-[#27272A] rounded-2xl p-6 border border-zinc-800 space-y-3"
              >
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 bg-[#FF6B4A] rounded-lg flex items-center justify-center shrink-0">
                    <Lightbulb className="w-4 h-4 text-white" />
                  </div>
                  <h3 className="text-white text-lg font-bold pt-0.5">
                    {tip.title}
                  </h3>
                </div>
                <p className="text-zinc-300 text-sm leading-relaxed">
            ...
            <div className="bg-[#1F1F22] rounded-2xl p-6 border border-zinc-800/50 mt-8">
              <p className="text-zinc-400 text-center text-sm">Best of luck! 😁👍</p>
            </div>
          </div>
        )}
